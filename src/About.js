  ...
  return (
    ...
    <div className = "p1">
     ...
     <div className = "p2">
      ...
      <div class = "vol1">
        <p>I’m passionate about volunteering for various organizations, and each role has contributed to honing my leadership and communication skills. 
          As VP of Events for the University of Ottawa Hong Kong Cultural Association and a Mentor at PennyDrops, I’ve gained invaluable experience in 
    ...
    <div className = "p4">
      ...
      <div class = "hobby">
        <p>Outdoors, I enjoy traveling (I miss it so badly), badminton, going to the gym, swimming, and running; I’m currently training for a half marathon, with my personal best at 10 km in 
